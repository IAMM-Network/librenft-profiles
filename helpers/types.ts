...
export type eNetwork = eEthereumNetwork | ePolygonNetwork | eXDaiNetwork | eGodWokenNetwork;
...
export interface iGodWokenParamsPerNetwork<T> {
  [eGodWokenNetwork.gwTestnet]: T;
  [eGodWokenNetwork.gwMainnet]: T;
}
