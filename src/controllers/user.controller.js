    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [2 /*return*/, res.send(user.toJSON())];
                case 2:
                    e_1 = _a.sent();
...
function getUserHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userAddress, userQuery, user, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    userAddress = req.params.publicAddress;
                    logger_1["default"].info("searching public address: " + userAddress);
                    userQuery = { publicAddress: userAddress };
                ...
                case 1:
                    ...
                    if (user) {
                        ...
                        return [2 /*return*/, res.json('{"status":"error","message":"User not found"}')];
                    }
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
